...
if(isset($_REQUEST["privk1"]))
{
	...
	$token=mysqli_real_escape_string($_REQUEST["token"]);
	echo "$token - ".$_REQUEST["token"];
	$privk1=mysqli_real_escape_string($_REQUEST["privk1"]);
	$privk2=mysqli_real_escape_string($_REQUEST["privk2"]);
	$pubk1=mysqli_real_escape_string($_REQUEST["pubk1"]);
	$pubk2=mysqli_real_escape_string($_REQUEST["pubk2"]);
	$host=mysqli_real_escape_string($_REQUEST["host"]);
