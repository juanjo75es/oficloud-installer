...
<div id="license" style="width:100%;">
	<div class="head">
		<div class="width">
			<h1>License for Oficloud Key-Sharing Server Installer</h1>
		</div>
	</div>
	<div class="width">
		<div class="terms">
			<h2>Oficloud Key-Sharing Server Installer - Terms and conditions</h2><ol><li>
<p><strong>Preamble:</strong> This Agreement, governs the relationship between you, (hereinafter: Licensee) and Oficloud SL (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using Oficloud Key-Sharing Server Installer (hereinafter: The Software) created and owned by Licensor, as detailed herein</p>
</li><li>
<p><strong>License Grant:</strong> Licensor hereby grants Licensee a Sublicensable, Non-assignable &amp; non-transferable, Pepetual, Non-commercial, Without the rights to create derivative works, Non-exclusive license, all with accordance with the terms set forth and other legal restrictions set forth in 3rd party software used while running Software.</p>
<ol>
<li>
...
<p><strong>Non-Commercial: </strong>Licensee may not use Software for commercial purposes. for the purpose of this license, commercial purposes means that a 3rd party has to pay in order to access Software or that the Website that runs Software is behind a paywall.</p>
</li><li> <p><strong>With support &amp; maintenance:</strong> Licensor shall provide Licensee support and maintenance as follows - <br /> </p> </li></ol></li><li> <strong>Term &amp; Termination:</strong> The Term of this license shall be until terminated. Licensor may terminate this Agreement, including Licensee&rsquo;s license in the case where Licensee : <ol>
<li>
...
<li>
<p><strong>Support:</strong> Software is provided with limited support, as detailed in the Software’s SLA detailed under the License Grant. Licensor shall provide support via the Binpress issue tracker and / or electronic mail and on regular business days and hours.</p>
<ol>
<li>
...
<p><strong>Governing Law, Jurisdiction: </strong>Licensee hereby agrees not to initiate class-action lawsuits against   Licensor in relation to this license and to compensate Licensor for any   legal fees, cost or attorney fees should any claim brought by Licensee   against Licensor be denied, in part or in full.</p>
	...
	<input type="checkbox" id="license-accept">I accept </input>
</div>
<button class="btn" style="float: left;" onclick="location.href='index.php'">&lt;&lt;&lt;Previous</button>
...
<script type="text/javascript">
	function next()
	{
		var e=document.getElementById('license-accept');
		if(!e.checked)
		{
			alert("You must accept the license terms to install");
			return;
		}
		location.href="check-php.php";
	}
</script>
</body>
</html>